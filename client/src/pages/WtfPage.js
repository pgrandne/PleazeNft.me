...
const WtfPage = () => {
    return (
        <Container className='text-left'>
            ...
            <p>From this picture, we will create a sketch of you and send you by an NFT</p>
            ...
            <p>The minimum amount is 0.01 Matic, much more the deposit is important, much more you have the priority</p>
            <p>We respect yout privacy, the url that you sent is not stored on the blockchain, we just use it for creating the NFT and delete it after that</p>
